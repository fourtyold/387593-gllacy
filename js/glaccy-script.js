...
if (page.classList.contains("index-body")) {
...
///////////////////////////////////////////////////////////////////////////////////// MODAL CONTENT VAR
  ...
  var feedback_comment = feedback_popup.querySelector("[name=comment]");
  var feedback_comment_label = feedback_popup.querySelector("[for=comment-feedback]");
...
////////////////////////////////////////////////////////////////////////////////////// MODAL CONTENT
  ...
  feedback_comment.onfocus = function() {
    feedback_comment_label.classList.remove("label-color");
    feedback_comment_label.classList.add("label-show");
  };

  feedback_comment.onblur = function() {
    if (feedback_comment.value) {
      feedback_comment_label.classList.add("label-color");
      }
    else {
      feedback_comment_label.classList.remove("label-show");
      feedback_comment_label.classList.remove("label-color");
    }
  };
